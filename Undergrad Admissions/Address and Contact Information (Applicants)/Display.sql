...
-- Systems Info/PII
    SGBSTDN_EFF_TERM_DESC as Eff_Term,
...
WHERE
    ...
    AND EXISTS( SELECT * FROM SAAADMS WHERE SARADAP_PIDM = SPRIDEN_PIDM AND SARADAP_TERM_CODE_ENTRY = :select_term_code.STVTERM_CODE)
