...
select
        ...
        SPRIDEN.GOREMAL_EMAIL_ADDRESS as SU_Email,
        SPRIDEN.GORADID_ADDITIONAL_ID as SU_ID,
        SORPCOL_TRANS_REV_DATE as TRANS_REV_DATE,
        SORPCOL_ADMR_CODE as ADMR_CODE,
        SORPCOL_SGBI_DESC as College,
        f_get_desc_fnc('STVDEGC', SORDEGR_DEGC_CODE, 30) as DEGC_DESC,
        SORDEGR_DEGC_DATE as DEGC_DATE
