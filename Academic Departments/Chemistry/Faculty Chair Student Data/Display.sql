...
(
  ...
  WHERE
      ...
      AND SPRADDR.SPRADDR_VERSION = (SELECT MAX(SPRADDR_VERSION)
                                    ...
                                    AND    ADDR.SPRADDR_ATYP_CODE = SPRADDR.SPRADDR_ATYP_CODE
...
(
  SELECT
      ...
      SGRADVR_TERM_CODE_EFF,
      SGRADVR_ADVR_EMAIL,
      MA.SPRADDR_PIDM as SPRADDR_PIDM_MA,
      MA.SPRADDR_ATYP_CODE as SPRADDR_ATYP_CODE_MA,
      MA.SPRADDR_ATYP_DESC as SPRADDR_ATYP_DESC_MA,
      MA.SPRADDR_FROM_DATE as SPRADDR_FROM_DATE_MA,
      MA.SPRADDR_TO_DATE as SPRADDR_TO_DATE_MA,
      MA.SPRADDR_STREET_LINE1 as SPRADDR_STREET_LINE1_MA,
      MA.SPRADDR_STREET_LINE2 as SPRADDR_STREET_LINE2_MA,
      MA.SPRADDR_STREET_LINE3 as SPRADDR_STREET_LINE3_MA,
      MA.SPRADDR_CITY as SPRADDR_CITY_MA,
      MA.SPRADDR_STAT_CODE as SPRADDR_STAT_CODE_MA,
      MA.SPRADDR_ZIP as SPRADDR_ZIP_MA,
      PR.SPRADDR_PIDM as SPRADDR_PIDM_PR,
      PR.SPRADDR_ATYP_CODE as SPRADDR_ATYP_CODE_PR,
      PR.SPRADDR_ATYP_DESC as SPRADDR_ATYP_DESC_PR,
      PR.SPRADDR_FROM_DATE as SPRADDR_FROM_DATE_PR,
      PR.SPRADDR_TO_DATE as SPRADDR_TO_DATE_PR,
      PR.SPRADDR_STREET_LINE1 as SPRADDR_STREET_LINE1_PR,
      PR.SPRADDR_STREET_LINE2 as SPRADDR_STREET_LINE2_PR,
      PR.SPRADDR_STREET_LINE3 as SPRADDR_STREET_LINE3_PR,
      PR.SPRADDR_CITY as SPRADDR_CITY_PR,
      PR.SPRADDR_STAT_CODE as SPRADDR_STAT_CODE_PR,
      PR.SPRADDR_ZIP as SPRADDR_ZIP_PR,
      AC.SPRTELE_PIDM as SPRTELE_PIDM_AC,
      AC.SPRTELE_TELE_CODE as SPRTELE_TELE_CODE_AC,
      AC.SPRTELE_TELE_DESC as SPRTELE_TELE_DESC_AC,
      AC.SPRTELE_PHONE_AREA as SPRTELE_PHONE_AREA_AC,
      AC.SPRTELE_PHONE_NUMBER as SPRTELE_PHONE_NUMBER_AC,
      PC.SPRTELE_PIDM as SPRTELE_PIDM_PC,
      PC.SPRTELE_TELE_CODE as SPRTELE_TELE_CODE_PC,
      PC.SPRTELE_TELE_DESC as SPRTELE_TELE_DESC_PC,
      PC.SPRTELE_PHONE_AREA as SPRTELE_PHONE_AREA_PC,
      PC.SPRTELE_PHONE_NUMBER as SPRTELE_PHONE_NUMBER_PC,
  ...
  FROM
      ADVISING_LIST_DEMO A
      LEFT OUTER JOIN TUIADDR MA ON MA.SPRADDR_PIDM = SPRIDEN_PIDM
           AND MA.SPRADDR_ATYP_CODE = 'MA'
      LEFT OUTER JOIN TUIADDR PR ON PR.SPRADDR_PIDM = SPRIDEN_PIDM
           AND PR.SPRADDR_ATYP_CODE = 'PR'
      LEFT OUTER JOIN SPATELE AC ON AC.SPRTELE_PIDM = SPRIDEN_PIDM
           AND AC.SPRTELE_TELE_CODE = 'AC'
      LEFT OUTER JOIN SPATELE PC ON PC.SPRTELE_PIDM = SPRIDEN_PIDM
           AND PC.SPRTELE_TELE_CODE = 'PC'
      LEFT OUTER JOIN SPAEMRG SPREMRG ON SPREMRG.SPREMRG_PIDM = SPRIDEN_PIDM
...
-- Email, Telephone, & Address
    ...
    SPRADDR_ATYP_CODE_MA as MA_ADDR_ATYP_Code,
    SPRADDR_ATYP_DESC_MA as MA_ADDR_ATYP_Desc,
    SPRADDR_FROM_DATE_MA as MA_ADDR_From_Date,
    SPRADDR_TO_DATE_MA as MA_ADDR_To_date,
    SPRADDR_STREET_LINE1_MA as MA_ADDR_Street_1,
    SPRADDR_STREET_LINE2_MA as MA_ADDR_Street_2,
    SPRADDR_STREET_LINE3_MA as MA_ADDR_Street_3,
    SPRADDR_CITY_MA as MA_ADDR_City,
    SPRADDR_STAT_CODE_MA as MA_ADDR_State,
    SPRADDR_ZIP_MA as MA_ADDR_Zip,
    SPRADDR_ATYP_CODE_PR as PR_ADDR_ATYP_Code,
    SPRADDR_ATYP_DESC_PR as PR_ADDR_ATYP_Desc,
    SPRADDR_FROM_DATE_PR as PR_ADDR_From_Date,
    SPRADDR_TO_DATE_PR as PR_ADDR_To_date,
    SPRADDR_STREET_LINE1_PR as PR_ADDR_Street_1,
    SPRADDR_STREET_LINE2_PR as PR_ADDR_Street_2,
    SPRADDR_STREET_LINE3_PR as PR_ADDR_Street_3,
    SPRADDR_CITY_PR as PR_ADDR_City,
    SPRADDR_STAT_CODE_PR as PR_ADDR_State,
    SPRADDR_ZIP_PR as PR_ADDR_Zip,
    SPRTELE_TELE_CODE_AC as AC_TELE__Code,
    SPRTELE_TELE_DESC_AC as AC_TELE__Desc,
    SPRTELE_PHONE_AREA_AC as AC_TELE__Phone_Area,
    SPRTELE_PHONE_NUMBER_AC as AC_TELE__Phone_Numb,
    SPRTELE_TELE_CODE_PC as PC_TELE__Code,
    SPRTELE_TELE_DESC_PC as PC_TELE__Desc,
    SPRTELE_PHONE_AREA_PC as PC_TELE__Phone_Area,
    SPRTELE_PHONE_NUMBER_PC as PC_TELE__Phone_Numb,
...
-- Academic Standing
    ...
    SHRTTRM_ASTD_DATE_END_OF_TERM as ASTD_Desc_End_of_Term,
...
--$beginorder
-- this measures
-- thats all this measures. this does not.
