 ...
 (
  ...
  -- ESF/SU ID DETAILS & EMAIL
   S.SPRIDEN_ID Banner_ID,
    ...
    SGBSTDN.SGBSTDN_PROGRAM_1 Program,
...
/* [HELPDESK REQUEST: #11605]
  ...
  -- TERM SELECTION
    join STVTERM STVTERM
      on STVTERM.STVTERM_CODE = :lb_Select_Term_Code.STVTERM_CODE
  ...
  and SGBSTDN.SGBSTDN_DEPT_CODE = :lb_Select_Dept_Code.STVDEPT_CODE
