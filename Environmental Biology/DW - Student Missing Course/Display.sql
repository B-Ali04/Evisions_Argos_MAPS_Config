...
(
  ...
  FROM
      ...
      LEFT OUTER JOIN SSAMEET SSRMEET ON SSRMEET.SSRMEET_TERM_CODE = SSBSECT.SSBSECT_TERM_CODE
...
WHERE
    ...
    AND NOT EXISTS (SELECT * FROM rad_class_dtl@dgw13.dgw
...
/*
    AND       SFRSTCA_SURROGATE_ID = (SELECT MAX(      SFRSTCA_SURROGATE_ID)
                               FROM    SFRSTCA STCA
                               WHERE   STCA.SFRSTCA_PIDM = SFRSTCA_PIDM
                               AND     STCA.SFRSTCA_TERM_CODE = SFRSTCA_TERM_CODE)
                               */
