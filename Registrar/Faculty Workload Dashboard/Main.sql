...
(
  ...
  FROM
      SSASECT SSBSECT
      LEFT OUTER JOIN SIRASGQ SIRASGN ON SSBSECT.SSBSECT_TERM_CODE = SIRASGN.SIRASGN_TERM_CODE
           AND SSBSECT.SSBSECT_CRN = SIRASGN.SIRASGN_CRN
           AND SIRASGN_PRIMARY_IND = 'Y'
      ...
      LEFT OUTER JOIN GOAEMAL GOREMAL ON GOREMAL.GOREMAL_PIDM = SIRDPCL_PIDM
  ),
...
-- reporting
SELECT
    SIRDPCL_PIDM as Remove_Label_From_Dashboard,
