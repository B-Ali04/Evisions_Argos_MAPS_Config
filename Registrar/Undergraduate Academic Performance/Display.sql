...
-- Cummulative & Semester GPA
    SHRTGPA_HOURS_ATTEMPTED as Term_GPA_Hours_Attempted,
    SHRTGPA_HOURS_EARNED as Term_GPA_Hours_Earned,
    SHRTGPA_GPA_HOURS as Term_GPA_Hours,
    SHRTGPA_QUALITY_POINTS as Term_Quality_Points,
    SHRTGPA_GPA as Term_GPA,
    SHRLGPA_HOURS_ATTEMPTED as Cum_Hours_Attempted,
    SHRLGPA_HOURS_EARNED as Cum_Hours_Earned,
    ...
    SHRTTRM_ASTD_DATE_END_OF_TERM as ASTD_Date,
...
WHERE
    ...
    AND SGBSTDN_MAJR_CODE_1 NOT IN ('0000', 'UNDC', 'EHS', 'SUS')
