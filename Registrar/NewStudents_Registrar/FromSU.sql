SELECT DISTINCT TO_DATE(TO_CHAR(SYSDATE,'MM/DD/YYYY'),'MM/DD/YYYY') AS ACTION_DT
       ,LASTNAME AS LAST_NAME_SRCH
       ,FIRSTNAME AS FIRST_NAME_SRCH
       ,SSN AS NATIONAL_ID
       ,SUID AS EMPLID
       ,BIRTHDATE
       ,CONCAT('ESF',SUBSTR(SU_LEVEL,1,1)) AS ACAD_CAREER
       ,BANNERID AS NEW_INFO2
       ,LASTNAME AS C_LAST
       ,FIRSTNAME AS C_FIRST
       ,SU_POS AS ACAD_PROG
       ,'ACTV' AS PROG_ACTION
