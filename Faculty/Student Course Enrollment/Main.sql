...
FROM
      --CLASS_LIST CL1                 -- ENROLLED STUDENT GRAD YEAR
      --COURE_ENROLLED_1 CE1         -- STUDENT COURSE ENROLLEMENT
      --SCHEDULE_VIEW_1 SV1          -- COURSE SCHEDULE
      GRADES_VIEW_1                -- STUDENT GRADES ROSTER
WHERE
--ENROLLED STUDENT
