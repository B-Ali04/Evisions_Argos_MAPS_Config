...
(
  ...
  WHERE
--      SPRADDR.SPRADDR_ATYP_CODE IN ('C2', 'C1', 'HR', 'TE', 'UN', 'H2', 'BI', 'BU', 'MA', 'P2', 'PA', 'PR', 'XX', 'SV', 'CH')
      SPRADDR.SPRADDR_ATYP_CODE IN (:select_atyp_code.STVATYP_CODE)
...
--                                    AND    ADDR.SPRADDR_ATYP_CODE IN ('C2', 'C1', 'HR', 'TE', 'UN', 'H2', 'BI', 'BU', 'MA', 'P2', 'PA', 'PR', 'XX', 'SV', 'CH')
                                    AND    ADDR.SPRADDR_ATYP_CODE IN (:select_atyp_code.STVATYP_CODE)
...
(
  ...
  WHERE
      SHRDGMR_GRAD_DATE >= :select_min_date
...
(
  ...
  FROM
      ...
      LEFT OUTER JOIN TUIADDR SPRADDR ON SPRADDR.SPRADDR_PIDM = SPRIDEN_PIDM
            AND SPRADDR_ATYP_CODE = :select_atyp_code.STVATYP_CODE
